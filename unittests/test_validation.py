...
class TestValidation(unittest.TestCase):
	...
	def test_check_email_negative(self):
		"""Check if wrong email matched"""
		
		str_to_test = "alexgmИЛail.com"
		result = self.validator.check_email(str_to_test)
		self.assertIsNone(result)
	
	def test_check_cyrrilic_negative(self):
		"""Check if matched non-cyrillic text for cyrillik pattern"""
	...
	def test_check_cyrrilic_positive(self):
		"""Check if matched cyrillic text for cyrillik pattern"""
	...
	def test_check_name_negative(self):
		"""Check if matched non correct name"""
	...
	def test_check_login_positive(self):
		"""Check if matched correct login"""
	...
	def test_check_login_negative(self):
		"""Check if matched non correct login"""
